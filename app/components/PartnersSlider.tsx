...
// Importar todas las imágenes de socios desde package-nosotros (mismo directorio que sobre-nosotros.tsx)
...
const PartnersSlider: React.FC = () => {
  // Array de socios homologado con sobre-nosotros.tsx
  const partners = [
        ...
        <div className="partners-with-button">
          <div className="partners-slider-wrapper">
            <motion.div
              ...
              transition={{
                duration: partners.length * 1, // Velocidad homologada con ChambersSlider
                repeat: Infinity,
                ease: "linear",
              }}
            >
